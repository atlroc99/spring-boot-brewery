...
public class MvcExceptionHandler {
    ...
    public ResponseEntity<List> constrainExceptionHandler(ConstraintViolationException constrains) {

        List<String> errors = new ArrayList<>(constrains.getConstraintViolations().size());
        constrains.getConstraintViolations().forEach( constraintViolation -> {
